...
public class CustomerTask {
	...
	public Map<Object,Map> getAccountInfo(int customerId,long aNumber)throws UserDefinedException{
		return bInterface.getAccountInfo(customerId, aNumber);
	}
	// show customer id to get all account info  CASE 9 customer and admin
	public Map<Object,Object> getCustomerIdToGetAllAccountInfo(int customerId)throws UserDefinedException{
		return bInterface.getCustomerIdToGetAllAccountInfo(customerId);
	}
	// show transaction info CASE 4 customer and admin
	public Map<Object,Object> getTransactionInfo(int customerId,long aNumber)throws UserDefinedException{
